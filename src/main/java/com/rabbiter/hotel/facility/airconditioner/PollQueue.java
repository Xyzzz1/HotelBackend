...
public class PollQueue extends QueueController {
    ...
    public static List<AirConditionerUserDTO> getUser1(QueueDTO qdt) {
        ArrayList<AirConditionerUserDTO> result=new ArrayList<>();
        AirConditionerUserDTO[] arr=new AirConditionerUserDTO[resource_num];//创建服务数组，使得每个资源服务的有对应的人
        //将服务队列的转换为数组arr
